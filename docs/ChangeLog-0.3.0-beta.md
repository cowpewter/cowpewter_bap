# Changelog v0.2.1-alpha to v0.3.0-beta
...
New shipping bin texture (edited from vanilla chest)
...
Added Reliable Name Tags for renaming without an anvil (right-click nametag in air)
